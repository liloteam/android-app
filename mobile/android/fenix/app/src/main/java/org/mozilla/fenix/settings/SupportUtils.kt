...
object SupportUtils {
    ...
    //LILO: return the Lilo URLs
    val GOOGLE_US_URL = LLModule.LLSupportUtils.getLiloUrl(LLModule.LLSupportUtils.URLType.GOOGLE_URL)//"https://www.google.com/webhp?client=firefox-b-1-m&channel=ts"
    val GOOGLE_XX_URL = LLModule.LLSupportUtils.getLiloUrl(LLModule.LLSupportUtils.URLType.GOOGLE_URL)//"https://www.google.com/webhp?client=firefox-b-m&channel=ts"
    val WHATS_NEW_URL = LLModule.LLSupportUtils.getLiloUrl(LLModule.LLSupportUtils.URLType.FAQ)//"https://www.mozilla.org/firefox/android/notes"
    val FXACCOUNT_SUMO_URL = LLModule.LLSupportUtils.getLiloUrl(LLModule.LLSupportUtils.URLType.SUPPORT)//"https://support.mozilla.org/kb/access-mozilla-services-firefox-account"
    val ANDROID_SUPPORT_SUMO_URL = LLModule.LLSupportUtils.getLiloUrl(LLModule.LLSupportUtils.URLType.SUPPORT)//"mzl.la/AndroidSupport"
    ...
    fun getSumoURLForTopic(
        ...
        //LILO: return the Lilo support URL
        return LLModule.LLSupportUtils.getLiloUrl(LLModule.LLSupportUtils.URLType.SUPPORT)
    ...
    fun getMozillaPageUrl(page: MozillaPage, locale: Locale = Locale.getDefault()): String {
        val path = page.path
        val langTag = getLanguageTag(locale)
        //LILO: return the Lilo FAQ URL
        return LLModule.LLSupportUtils.getLiloUrl(page)
