...
import org.mozilla.fenix.LLSettings
...
class LLMain {
    companion object {
        fun initializeLilo(context: Context) {
            ...
            context.components.core.engine.settings.userAgentString = LLSettings.customizedUserAgent(context, engineSettings.userAgentString)
